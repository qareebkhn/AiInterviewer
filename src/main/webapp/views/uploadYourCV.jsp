...
<title>AI Interviewer - Upload Your CV</title>
<link
...
<body>
	...
	<!-- Upload Your CV -->
	<div id="upload_your_cv_cont" class="container-fluid">
		<div
			...
			<div class="col-lg-6 mx-auto">
				...
				<div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
					<div class="d-grid gap-2 col-6 mx-auto mb-5">
						<form id="uploadForm" action="/cvupload" method="POST"
							...
							<input type="file" id="fileInput" name="file" accept=".pdf,.docx"
								...
								Your CV</label>
							<!-- No need for a submit button, form will submit automatically -->
						</form>
